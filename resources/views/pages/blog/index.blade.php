...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Quản Lý Bài Viết'])
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <livewire:blogs-table-view />
                            <div class="modal fade" id="modal-notification" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
                                <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h6 class="modal-title" id="modal-title-notification">Xác nhận xóa bài viết</h6>
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            $('.container-text').text('');
            id = $(this).data('id');
            $('.container-text').text('Bạn có chắc chắn muốn xóa bài viết ' + $(this).data('title') + ' không?' );
        });
        $('.btn-submit').click(function(){
            $.ajax({
                url: '{{route('admin.blog.destroy', ["blog" => 'id'])}}',
                method: 'DELETE',
                data: {
                    id: id,
                    _token: '{{csrf_token()}}'
