                        ...
                        <form id="apiForm">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea id="link" class="form-control" rows="5"
                                    name="link">https://otruyenapi.com/v1/api/danh-sach</textarea>
                                <small><i>Mỗi link cách nhau 1 dòng (nếu nhiều link thì bắt buộc không được có link:
                                        https://otruyenapi.com/v1/api/danh-sach)</i></small>
                            </div>
