                    ...
                    <div class="splide__list">
                        <div class="splide__slide">
                            <div class="sl-wrapper">
                                ...
                                <div class="mb-left mb-banner">
                                    <a href="/the-loai/manga" aria-label="Hentai"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-11.png" alt="" /></a>
                                </div>
                                <div class="mb-mid__banner">
                                    <div class="sm-tag">Truyện<span>Hentai</span></div>
                                    <div class="mb-mid mb-banner">
                                        <a href="/the-loai/manga" aria-label="Hentai"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-12.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="mb-right mb-banner">
                                    <a href="/the-loai/manga" aria-label="Hentai"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-13.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="splide__slide 3d-hentai">
                            <div class="sl-wrapper">
                                <img class="lzl bg-slide" data-splide-lazy="/assets/images/bg-slide2.png" alt="banner" />
                                <div class="mb-left mb-banner">
                                    <a href="/the-loai/3d-hentai" aria-label="3D Hentai"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-21.png" alt="" /></a>
                                </div>
                                <div class="mb-mid__banner">
                                    <div class="sm-tag">Truyện<span>3D Hentai</span></div>
                                    <div class="mb-mid mb-banner">
                                        <a href="/the-loai/3d-hentai" aria-label="3D Hentai"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-22.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="mb-right mb-banner">
                                    <a href="/the-loai/dc-comics" aria-label="3D Hentai"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-23.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="splide__slide kor-comics">
                            <div class="sl-wrapper">
                                ...
                                <div class="mb-left mb-banner">
                                    <a href="/the-loai/manhwa" aria-label="Manhwa Hentai"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-31.png" alt="" /></a>
                                </div>
                                <div class="mb-mid__banner">
                                    <div class="sm-tag">Truyện<span>Manhwa Hentai</span></div>
                                    <div class="mb-mid mb-banner">
                                        <a href="/the-loai/manhwa" aria-label="Manhwa Hentai"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-32.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="mb-right mb-banner">
                                    <a href="/the-loai/manhwa" aria-label="Manhwa Hentai"><img class="slide-img lzl"
                                            data-splide-lazy="/assets/images/mb-33.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="splide__slide marvel-comics">
                            <div class="sl-wrapper">
                                ...
                                <div class="mb-left mb-banner">
                                    <a href="/the-loai/marvel-comics" aria-label="Con Gái"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-41.png" alt="" /></a>
                                </div>
                                <div class="mb-mid__banner">
                                    <div class="sm-tag">
                                        Truyện<span>Con Gái</span>
                                    </div>
                                    <div class="mb-mid mb-banner">
                                        <a href="/the-loai/marvel-comics" aria-label="Con Gái"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-42.png" alt="" /></a>
                                    </div>
                                </div>
                                <div class="mb-right mb-banner">
                                    <a href="/the-loai/marvel-comics" aria-label="Con Gái"><img class="slide-img"
                                            data-splide-lazy="/assets/images/mb-43.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="splide__slide chi-comics">
                                <div class="sl-wrapper">
                                    ...
                                    <div class="mb-left mb-banner">
                                        <a href="/the-loai/manhua" aria-label="Trung Quốc"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-51.png" alt="" /></a>
                                    </div>
                                    <div class="mb-mid__banner">
                                        <div class="sm-tag">Truyện<span>TRUNG QUỐC</span></div>
                                        <div class="mb-mid mb-banner">
                                            <a href="/the-loai/manhua" aria-label="Trung Quốc"><img class="slide-img"
                                                    data-splide-lazy="/assets/images/mb-52.png" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="mb-right mb-banner">
                                        <a href="/the-loai/manhua" aria-label="Trung Quốc"><img class="slide-img"
                                                data-splide-lazy="/assets/images/mb-53.png" alt="" /></a>
                                    </div>
                                </div>
                            </div> -->
                    </div>
                            ...
                            <div class="m-post splide__slide">
                                ...
                                @elseif ($loop->iteration == 3)
                                    <svg xmlns="http://www.w3.org/2000/svg" width="62" height="77" viewBox="0 0 62 77" fill="none">
                                        <path
                                            ...
                                            stroke="#596FB7" stroke-width="2" fill="none"></path>
                                    </svg>
                                @elseif ($loop->iteration == 4)
                                    <svg xmlns="http://www.w3.org/2000/svg" width="71" height="76" viewBox="0 0 71 76" fill="none">
                                        <path
                                            ...
                                            stroke="#2B4992" stroke-width="2" fill="none"></path>
                                    </svg>
                                    ...
                                    <a title="{{$item->name}}" href="{{route('detail', ['slug' => $item->slug])}}">
                                        <span class="img-poster">
                                            <img class="lzl" data-src="{{$item->thumbnail}}" rel="nofollow"
                                                ...
                                                src="/assets/images/pre-load1.png" width="100%" height="100%">
                                        </span>
                                    </a>
                                </div>
                                ...
                                <div class="p-content flex-grow-1">
                                    ...
                                    <div class="group-star">
                                        ...
                                        <span class="num-view">{{\Illuminate\Support\Number::abbreviate($item->view_total)}}
                                            lượt xem</span>
                                        ...
                                        @foreach ($item->chapters->take(-2) as $chapter)
                                            <li class="chapter">
                                                <a data-id="{{$chapter->id}}"
                                                    href="{{route('showRead', ['slug' => $item->slug, 'chapter' => $chapter->slug])}}"
                                                    title="{{$chapter->name}}">
                                                    ...
                                                    @foreach ($item->chapters->take(-2) as $chapter)
                                                        <li class="chapter">
                                                            <a data-id="{{$chapter->id}}"
                                                                ...
                                                                title="{{$chapter->name}}">
                                                                Chapter
                                                                {{$chapter->name}}<span>{{$chapter->created_at->diffForHumans()}}</span>
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                    ...
                    <section id="top-follow">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="" class="nav-link active" id="day-tab" data-bs-toggle="tab" data-bs-target="#day"
                                    role="tab" aria-controls="day" aria-selected="true">Ngày</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                @foreach ($newComments as $item)
                                    <li class="splide__slide">
                                        <div class="tc-item">
                                            <div class="tc-v">
                                                <div class="tc-header">
                                                    <div class="user-avatar"><img alt="" rel="nofollow"
                                                            src="{{$item->user->avatar}}" /></div>
                                                    <div class="info">
                                                ...
                                                <div class="tc-thumb">
                                                    <a class="tc-thumbnail" title="{{$item->comic->name}}"
                                                        href="{{route('detail', ['slug' => $item->comic->slug])}}">
                                                        <img class="lzl" data-src="{{$item->comic->thumbnail}}" rel="nofollow"
                                                            alt="{{$item->comic->name}}" src="/assets/images/pre-load1.png"
                                            ...
                                            <div class="tc-footer">
                                                <a href="{{route('detail', ['slug' => $item->comic->slug])}}"
                                                    class="tc-name">{{$item->comic->name}}</a>
                                            </div>
                                            <a class="tc-link"
                                                href="{{route('detail', ['slug' => $item->comic->slug])}}#cmt-{{$item->id}}"></a>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
                        ...
                        @foreach ($categories as $item)
                            <div class="g-item splide__slide">
                                <div class="genre-content">
                                    <a href="{{route('showCategory', ['slug' => $item->slug])}}" class="g-link"
                            ...
                            <div class="splide__slide">
                                <div class="item-card">
                                    ...
                                    <div class="item-content">
                                        <h3 class="item-title"><a href="{{route('showBlog', ['slug' => $item->slug])}}"
                                                alt="">{{$item->title}}</a></h3>
                                        <div class="item-description">{!! Str::limit((strip_tags($item->content)), 100) !!}
                                        </div>
                                        <div class="item-info">
                                            ...
                                            <span class="author">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <path
                                                        d="M8.10646 7.74732C8.08646 7.74732 8.07313 7.74732 8.05313 7.74732C8.01979 7.74065 7.97313 7.74065 7.93313 7.74732C5.99979 7.68732 4.53979 6.16732 4.53979 4.29398C4.53979 2.38732 6.09313 0.833984 7.99979 0.833984C9.90646 0.833984 11.4598 2.38732 11.4598 4.29398C11.4531 6.16732 9.98646 7.68732 8.12646 7.74732C8.11979 7.74732 8.11313 7.74732 8.10646 7.74732ZM7.99979 1.83398C6.64646 1.83398 5.5398 2.94065 5.5398 4.29398C5.5398 5.62732 6.57979 6.70065 7.90646 6.74732C7.93979 6.74065 8.03313 6.74065 8.1198 6.74732C9.42646 6.68732 10.4531 5.61398 10.4598 4.29398C10.4598 2.94065 9.35313 1.83398 7.99979 1.83398Z"
                                                        fill="#787978" />
                                                    <path
                                                        d="M8.11307 15.0327C6.80641 15.0327 5.49307 14.6993 4.49974 14.0327C3.57307 13.4193 3.06641 12.5793 3.06641 11.666C3.06641 10.7527 3.57307 9.90602 4.49974 9.28602C6.49974 7.95935 9.73974 7.95935 11.7264 9.28602C12.6464 9.89935 13.1597 10.7393 13.1597 11.6527C13.1597 12.566 12.6531 13.4127 11.7264 14.0327C10.7264 14.6993 9.41974 15.0327 8.11307 15.0327ZM5.05307 10.126C4.41307 10.5527 4.06641 11.0993 4.06641 11.6727C4.06641 12.2393 4.41974 12.786 5.05307 13.206C6.71307 14.3193 9.51307 14.3193 11.1731 13.206C11.8131 12.7793 12.1597 12.2327 12.1597 11.6593C12.1597 11.0927 11.8064 10.546 11.1731 10.126C9.51307 9.01935 6.71307 9.01935 5.05307 10.126Z"
                                                        fill="#787978" />
                                                </svg>{{$item->user->name}}
                                            </span>
                                            ...
                                            <span class="date">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#787978" />
                                                    <path
                                                        d="M10 1.83398H6C5.72667 1.83398 5.5 1.60732 5.5 1.33398C5.5 1.06065 5.72667 0.833984 6 0.833984H10C10.2733 0.833984 10.5 1.06065 10.5 1.33398C10.5 1.60732 10.2733 1.83398 10 1.83398Z"
                                                        fill="#787978" />
                                                </svg>
