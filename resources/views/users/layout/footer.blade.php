<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-4">
                <div class="f-left">
                    ...
                    <p class="mt-3">{{env('APP_NAME')}} là website đọc <b>truyện tranh</b> online uy tín hàng đầu Việt Nam. Tất cả các truyện trên website đăng tải được Hangtruyen biên dịch và tổng hợp từ nhiều nguồn trên Internet.</p>
                </div>
            </div>
            <div class="col-12 col-lg-6">
                <ul class="f-menu">
                    <li><a href="{{route('about')}}" rel="nofollow">Về chúng tôi</a></li>
                    <li><a href="{{route('contact')}}" rel="nofollow">Phương thức liên hệ</a></li>
                    <li><a href="{{route('terms')}}" rel="nofollow">Điều khoản dịch vụ</a></li>
                    <li><a href="{{route('disclaimer')}}" rel="nofollow">Tuyên bố miễn trừ trách nhiệm</a></li>
                    <li><a href="{{route('privacy')}}" rel="nofollow">Chính sách bảo mật</a></li>
                </ul>
            </div>
            <div class="col-12 col-lg-2">
                <ul class="social-link">
                    <li>
                        <a href="https://t.me/onezoroone" aria-label="Facebook" rel="nofollow">
                            <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                                <g clip-path="url(#clip0_392_113156)">
                                    <path d="M34 17C34 7.61115 26.3888 0 17 0C7.61115 0 0 7.61115 0 17C0 25.4851 6.21662 32.5181 14.3438 33.7935V21.9141H10.0273V17H14.3438V13.2547C14.3438 8.99406 16.8818 6.64062 20.7649 6.64062C22.6243 6.64062 24.5703 6.97266 24.5703 6.97266V11.1562H22.4267C20.315 11.1562 19.6562 12.4668 19.6562 13.8125V17H24.3711L23.6174 21.9141H19.6562V33.7935C27.7834 32.5181 34 25.4851 34 17Z" fill="white"></path>
                                </g>
                                <defs>
        ...
        <p class="copyright text-center">Copyright © 2025, All rights reserved.</p>
    </div>
    <span id="back-totop" style="display: inline;">

    </span>
</footer>
<div href="javascript:void(0)" id="back-to-top" style="display: flex; cursor: pointer; opacity: 0; transition: opacity 0.3s;">
