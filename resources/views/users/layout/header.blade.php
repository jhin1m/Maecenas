    ...
    <div class="container">
        <div class="main-header d-flex align-items-center">
            ...
            <a class="logo" title="Truyện tranh online" href="/">
                <img
                    class="logo-light"
                    alt="Đọc truyện tranh miễn phí tại {{env('APP_NAME')}}"
                    src="/logo.png"
                    width="150"
                    height="54"
                />
            ...
            <ul
                class="nav navbar-nav flex-row flex-wrap main-menu d-none d-xl-flex"
            >
                <li class="">
                ...
                <li class="has-sub">
                    <a href="{{route('showCategory')}}" class="sub-toggle" aria-expanded="false"
                        >Thể loại
            ...
            <div
                class="header-right d-flex align-items-center justify-content-end ms-auto"
            >
                <a
                    href="#"
                    class="toggle-formsearch ms-auto d-flex d-xl-none"
                    aria-label="Search"
                >
                ...
                <!-- Search Modal -->
                <form
                    class="d-xl-flex form-search"
                    id="form-search"
                    action="{{route('showSearch')}}"
                >
                    <input
                        class="form-control"
                        type="text"
                    ...
                    <div
                        class="nav search-result-wrapper"
                        id="search-suggest"
                        style="display: none"
                    >
                        <p>Gợi ý cho bạn</p>
                ...
                <div class="dark-mode d-none d-xl-block on">
                    <button
                        type="button"
                        class="btn-switch"
                    ...
                    >
                        <img
                            src="/assets/images/btn-lightmode.png"
                            class="light"
                            width="38"
                            height="35"
                            alt="Light mode"
                        />
                        <img
                            src="/assets/images/btn-darkmode.png"
                            class="dark"
                            width="38"
                            height="35"
                            alt="Dark mode"
                ...
                <div class="nav-account list-inline" id="not-loggin">
                    ...
                    <a
                        id="avatar"
                        class="d-flex d-xl-none user-avatar-img"
                        data-bs-toggle="modal"
                        data-bs-target="#loginModal"
                    >
                        <img
                ...
                <div class="dropdown nav-account" id="has-login">
                    ...
                    >
                        <img
                            id="avatar-temp-header"
                            class="avatar-temp user-avatar-img"
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="menumobile" aria-labelledby="offcanvasLabel">
    <div class="offcanvas-body">
        <div class="off-header">
            <div class="dark-mode on">
                <button type="button" class="btn-switch" aria-label="Switch mode">
                    <img src="/assets/images/btn-lightmode.png" class="light" width="38" height="35" alt="Light mode">
                    <img src="/assets/images/btn-darkmode.png" class="dark" width="38" height="35" alt="Dark mode">
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="d-flex flex-column align-items-center justify-content-center g_id_signin" style="min-height: 200px" action="{{route('auth-login')}}" method="POST">
                    @csrf
                    @if (session('error'))
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="Nhập email" required value="{{old('email')}}">
                    </div>
                    <div class="form-group w-100">
                        <label for="password" class="form-label">Mật khẩu</label>
                        <input type="password" class="form-control" name="password" id="password" placeholder="Mật khẩu" required>
                    </div>
                    <div class="form-group w-100">
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="d-flex flex-column align-items-center justify-content-center g_id_signin" style="min-height: 200px" action="{{route('auth-register')}}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên" required value="{{old('name')}}">
                    </div>
                    <div class="form-group w-100">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" name="email" id="email" placeholder="Nhập email" required value="{{old('email')}}">
                    ...
                    <div class="form-group w-100">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Nhập lại mật khẩu" required>
                    </div>
